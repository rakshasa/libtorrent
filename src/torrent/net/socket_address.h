...
bool sin_is_any(const sockaddr_in* sockaddr) LIBTORRENT_EXPORT;
bool sin6_is_any(const sockaddr_in6* sockaddr) LIBTORRENT_EXPORT;

bool sa_is_v4mapped(const sockaddr* sockaddr) LIBTORRENT_EXPORT;
bool sin6_is_v4mapped(const sockaddr_in6* sockaddr) LIBTORRENT_EXPORT;
