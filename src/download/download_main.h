...
public:
  ...
  auto                              tracker_controller() const     { return m_tracker_controller; }
  ...
  auto                connection_list() const                    { return m_connectionList; }
  ...
  void                receive_corrupt_chunk(PeerInfo* peerInfo) const;
