...
#define VERIFY_BUCKET_SIZES(s_0, s_1)            \
  CPPUNIT_ASSERT(buckets.bucket_size(0) == s_0); \
  CPPUNIT_ASSERT(buckets.bucket_size(1) == s_1);
